...
public $Blocks = [
  ...
  public $Miscellaneous = [
    ...
    "Enderpearl" => [368,0,10000,50],
    "Book & Quill" => [386,0,100,0],
    "Elytra" => [444,0,1000,50],
    "Boats" => [333,0,1000,50],
    "Totem of Undying" => [450,0,1000,50],
    "Golden Apple" => [322,0,5000,2500],
    "Enchanted Golden Apple" => [466,0,30000,50]
  ];
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§l§cSplex§dPE §fShop§r","       §fPurchase and Sell items Here!");
